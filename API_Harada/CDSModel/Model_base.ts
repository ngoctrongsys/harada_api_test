...
import { CONST_CDS_AUTHORITY_URL, CONST_CDS_CLIENT_ID, CONST_CDS_CLIENT_SECRET, CONST_CDS_REDIRECT_URL } from "../Constants";
...
export class Model_base {
    ...
    * @memberof Model_base
    */
    public static ClearCDSToken = function () {
        eval("g_accessToken = '';");
    };
    ...
    * @memberof Model_base
    */
    public static GetCDSToken = function () {
        ...
        return new Promise((resolve, reject) => {
            if (g_accessToken != '') {
                 ...
                 */
                const context = new AuthenticationContext(CONST_CDS_AUTHORITY_URL);
                context.acquireTokenWithClientCredentials(
                    CONST_CDS_REDIRECT_URL,
                    CONST_CDS_CLIENT_ID,
                    CONST_CDS_CLIENT_SECRET,
     ...
     * @memberof Model_base
     */
    public static MethodGet = (queryStr: string) => {
        ...
        return new Promise((resolve, reject) => {
            Model_base.GetCDSToken().then(accessToken => {
                    ...
                    instance.get(url).then(function (response: any) {
     ...
     * @memberof Model_base
     */
    public static MethodPost = (queryStr: string, JSONObjData: any) => {
        ...
        return new Promise((resolve, reject) => {
            Model_base.GetCDSToken().then(accessToken => {
                    ...
                    instance.post(url, JSONObjData).then(function (response: any) {
     ...
     * @memberof Model_base
     */
    public static MethodPatch = (queryStr: string, JSONObjData: any) => {
        ...
        return new Promise((resolve, reject) => {
            Model_base.GetCDSToken().then(accessToken => {
                    ...
                    instance.patch(url, JSONObjData).then(function (response: any) {
                            resolve({});
                        }).catch(function (error: any) {
                            try {
                                console.log(error.response.data.error);
     ...
     * @memberof Model_base
     */
    public static MethodPut = (queryStr: string, JSONObjData: any) => {
        ...
        return new Promise((resolve, reject) => {
            Model_base.GetCDSToken().then(accessToken => {
                    ...
                    instance.put(url, JSONObjData).then(function (response: any) {
                            resolve({});
                        }).catch(function (error: any) {
     ...
     * @memberof Model_base
     */
    public static MethodDelete = (queryStr: string) => {
        ...
        return new Promise((resolve, reject) => {
            Model_base.GetCDSToken().then(accessToken => {
                    ...
                    instance.delete(url).then(function (response: any) {
                            resolve({});
                        }).catch(function (error: any) {
     ...
     * @memberof Model_base
     */
    public static MethodGetPagination = (queryStr: string, maxPageSize: number) => {
        const functionName = 'METHOD_GET';
        F_Log(`${functionName} START`);
     ...
     * @memberof Model_base
     */
    public static MethodGetNextLink = (nextLink: string, maxPageSize: number) => {
        const functionName = 'METHOD_GET';
        F_Log(`${functionName} START`);
        ...
        return new Promise((resolve, reject) => {
            Model_base.GetCDSToken().then(accessToken => {
                    ...
                    instance.get(nextLink).then(function (response: any) {
