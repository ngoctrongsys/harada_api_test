 ...
 */
export class Model_user_management {
     ...
     */
    public static mTableName = `${CONST_CDS_PREFIX}user_managements`;
     ...
     * @memberof Model_user_management
     */
    public static mPrimaryKeyAuto = `${CONST_CDS_PREFIX}user_managementid`;
     ...
     * @memberof Model_user_management
     */
    public static mPrimaryKeyCustom = `${CONST_CDS_PREFIX}user_id`;
    ...
    public static SelectAll = () => {
        ...
        const queryStr = `${CONST_CDS_SUB_PATH}/${Model_user_management.mTableName}`;
    ...
    public static GetIncreaseCustomID = (customID: string) => {
        ...
        newCustomID = 'U' + F_PaddingLeft(newCustomID, '0', 6);
        return newCustomID;
    }
    ...
    public static SelectByAutoID = (id: any) => {
        ...
        const queryStr = `${CONST_CDS_SUB_PATH}/${Model_user_management.mTableName}(${id})`;
    ...
    public static SelectByCustomID = (customID: string) => {
        ...
        const queryStr = `${CONST_CDS_SUB_PATH}/${Model_user_management.mTableName}${queryOption}`;
     ...
     * @param entity 
     */
    public static Insert = (entity0: Entity_user_management) => {
     ...
     * @param entity 
     */
    public static UpdateByAutoID = (id: any, entity0: Entity_user_management) => {
     ...
     * @param entity 
     */
    public static DeleteEntity = (entity: Entity_user_management) => {
        const functionName = 'DeleteEntity';
        F_Log(`${functionName} START`);
        const autoID = F_GetValueByIndex(entity, Model_user_management.mPrimaryKeyAuto);
        if (autoID != undefined) {
            const queryStr = `${CONST_CDS_SUB_PATH}/${Model_user_management.mTableName}(${autoID})`;
            return new Promise((resolve, reject) => {
                Model_base.MethodDelete(queryStr).then(arrData => {
                        F_Log(`${functionName} OK`);
                        resolve(arrData);
