...
exports.ShopifyAdminAPI = void 0;
...
exports.ShopifyAdminAPI = ShopifyAdminAPI;
 ...
 */
ShopifyAdminAPI.GetOrders = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/orders.json?' + queryOption;
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
            'Content-Type': 'application/json',
            'Authorization': 'Basic ' + base64,
        };
        yield axios_1.default.get(url, { headers: header }).then(respone => {
            const orders = respone.data.orders;
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetOrdersWithConditionCreatedAt = (previousDate, currentDate) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_GetOrders_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        // &fields: Retrieve only certain fields, specified by a comma-separated list of fields names.
...
* @memberof ShopifyAdminAPI
*/
ShopifyAdminAPI.GetCustomerLogin = (customerId) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_GetCustomerLogin_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => {
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Customers + '/' + customerId + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        axios_1.default.get(url, { headers: header }).then(response => {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetVariantsOfProduct = (productId) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = `_GetProductInfo ${productId}_`;
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Product + '/' + productId + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.get(url, { headers: header }).then(respone => {
            ...
            const variantsCus = variants.map((item) => {
                if (item) {
                    const data = {
                        id: item === null || item === void 0 ? void 0 : item.id,
                        product_id: item === null || item === void 0 ? void 0 : item.product_id,
                        title: item === null || item === void 0 ? void 0 : item.title,
                        option1: item === null || item === void 0 ? void 0 : item.option1,
                        option2: item === null || item === void 0 ? void 0 : item.option2,
                        price: item === null || item === void 0 ? void 0 : item.price,
                        sku: item === null || item === void 0 ? void 0 : item.sku,
                        inventory_item_id: item === null || item === void 0 ? void 0 : item.inventory_item_id,
                        inventory_quantity: item === null || item === void 0 ? void 0 : item.inventory_quantity,
                        requires_shipping: item === null || item === void 0 ? void 0 : item.requires_shipping,
                        taxable: item === null || item === void 0 ? void 0 : item.taxable,
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetShopTaxesIncludes = () => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = `_GetShopTaxesIncludes_`;
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Shop + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.get(url, { headers: header }).then(respone => {
            const taxesIncludes = respone.data.shop.taxes_included;
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.UpdateCustomerById = (customerId, dataUpdate) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield axios_1.default.put(url, customerJSON, { headers: header }).then(respone => {
            resolve({});
        }).catch(error => {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.AddNewCustomerAddress = (customerId, dataUpdate) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const functionName = '_UpdateCustomerById_';
        FunctionCommon_1.F_Log(`${functionName} START`);
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/'
            + Constants_1.CONST_Harada_Tables.Customers + '/' + customerId + '/'
            + Constants_1.CONST_Harada_Tables.CustomerAddress + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.post(url, customerAddressJSON, { headers: header }).then(respone => {
            resolve({});
        }).catch(error => {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.UpdateCustomerAddressById = (customerId, customerAddressId, dataUpdate) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const functionName = '_UpdateCustomerById_';
        FunctionCommon_1.F_Log(`${functionName} START`);
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/'
            + Constants_1.CONST_Harada_Tables.Customers + '/' + customerId + '/'
            + Constants_1.CONST_Harada_Tables.CustomerAddress + '/' + customerAddressId + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.put(url, customerAddressJSON, { headers: header }).then(respone => {
            resolve({});
        }).catch(error => {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetOrdersByOrderId = (_ids) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        queryOption += `&status=any`;
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Order + '.json?' + queryOption;
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetOrdersOld = () => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_GetOrdersOldCode_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Order + '.json?status=any';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.InsertOrderOld = (_reqData) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_InsertOrder_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Order + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.post(url, orderJSON, { headers: header }).then(respone => {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.InsertOrder = (_reqData) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.UpdateOrder = (order) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_UpdateOrder(Shopify)_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Order + '/' + order.id + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.put(url, orderJSON, { headers: header }).then(respone => {
            const data = respone.data;
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.DeleteOrder = (orderId) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const url = Constants_1.CONST_Harada_Endpoints + '2020-10' + '/' + Constants_1.CONST_Harada_Tables.Order + '/' + orderId + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.delete(url, { headers: header }).then(respone => {
            const data = respone.data;
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.RefundTransaction = (_req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield axios_1.default.post(PAYPAL_PAYMENTS_API + captureID + '/refund', objRefund, { headers: header }).then(respone => {
            const data = respone.data;
            resolve(data);
        }).catch(error => {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetOrderDetail = (order_id) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_GetOrderDetail_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const COUNTRY_CODE_JAPAN = 'JP';
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Order + '/' + order_id + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.get(url, { headers: header }).then(respone => {
            ...
            if (shipping_address.country_code === COUNTRY_CODE_JAPAN) {
                ...
                const provinceOption = Constants_1.CONST_Harada_Province_Of_JP.find(x => x.key === province_code);
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetCheckouts = (_req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.AbandonedCheckouts + '.json?created_at_min=' + created_at_min + '&limit=' + limit;
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.get(url, { headers: header }).then(respone => {
            const checkouts = respone.data.checkouts;
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetFeeByShippingZone = (_req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.ShippingZone + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.get(url, { headers: header }).then(respone => {
            const shipping_zones = respone.data.shipping_zones;
            ...
            */
            ...
            if (shipping_zones.length > 0) {
                data = shipping_zones.map(shippingZone => {
                    ...
                    const item = countries.find((country) => country.code === country_code);
                    if (item !== undefined && item !== null) {
                        const shippingZoneId = item.shipping_zone_id;
                        const shippingZoneDetail = shipping_zones.find((_item) => _item.id === shippingZoneId);
                        if (shippingZoneDetail !== undefined && shippingZoneDetail !== null) {
                            ...
                            const listCarrier = carrierSRP.filter((_carrier) => _carrier.shipping_zone_id === shippingZoneId);
                            ...
                            // Get Carrier detail from to list[@carrierSRP]
                            const listPriceBased = priceBasedSR.filter((_priceBased) => _priceBased.shipping_zone_id === shippingZoneId);
                            if (listPriceBased.length > 0) {
                                price_based_shipping_rates = listPriceBased.reduce((a, b) => a + (parseInt(b['price'], 10) || 0), 0);
                                // 2021.12.23
                                const list_name_price_based_shipping_rates = listPriceBased.map((item) => { return item.name; }).join(', ');
                            ...
                            // Get Carrier detail from to list[@carrierSRP]
                            const listWeightBase = weightBasedSR.filter((_weightBased) => _weightBased.shipping_zone_id === shippingZoneId);
                            if (listWeightBase.length > 0) {
                                // weight_based_shipping_rates = weightBaseResult.price;
                                weight_based_shipping_rates = listWeightBase.reduce((a, b) => a + (parseInt(b['price'], 10) || 0), 0);
                                // 2021.12.23
                                const list_name_weight_based_shipping_rates = listWeightBase.map((item) => { return item.name; }).join(', ');
            ...
            data = data === null || data === void 0 ? void 0 : data.filter((x) => x.id != 0);
            resolve(data);
        }).catch(error => {
            reject(error);
        });
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetFeeTax = (_req) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_GetTax_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const country_code = _req.body.country_code;
        const province_code = _req.body.province_code;
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Country + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.get(url, { headers: header }).then(respone => {
            const countries = respone.data.countries;
            ...
            if (item !== undefined && item !== null) {
                ...
                if (item.tax === 0 && item.provinces.length > 0) {
                    ...
                    const itemProvince = item.provinces.find((province) => province.code === province_code);
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetUserById = (_req) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_GetUserById_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const COUNTRY_CODE_JAPAN = 'JP';
        const customer_id = _req.body.customerId;
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Customers + '/' + customer_id + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.get(url, { headers: header }).then(respone => {
            const customer = respone.data.customer;
            const data = {
                id: customer.id,
                email: customer.email,
                first_name: customer.first_name,
                ...
                addresses: customer.addresses.map((address) => {
                    const contry = Constants_1.CONST_Harada_Countries.find(x => x.key === address.country_code);
            ...
            if (!FunctionCommon_1.F_IsNullOrEmptyListItem(data) && !FunctionCommon_1.F_IsNullOrEmptyListItem(data.addresses)) {
                const addressesSort = data.addresses.sort((a, b) => (a.id > b.id) ? -1 : ((a.id < b.id) ? 1 : 0));
                const takeItem = 5;
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.UpdateCustomer = (_req) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_UpdateCustomer_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const reqData = _req.body.customer;
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Customers + '/' + reqData.id + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetProducts = () => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_GetProducts_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Product + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.get(url, { headers: header }).then(respone => {
            const products = respone.data.products;
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.SendEmail = (_req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const subtotal_price = FunctionCommon_1.F_FormatCurrency(orderData.subtotal_price).replace('￥', '');
        const shipping_price = FunctionCommon_1.F_FormatCurrency(orderData.shipping_price).replace('￥', '');
        const total_tax = FunctionCommon_1.F_FormatCurrency(orderData.total_tax).replace('￥', '');
        const total_price = FunctionCommon_1.F_FormatCurrency(orderData.total_price).replace('￥', '');
        ...
        const line_items_for_dynamic_transaction_email = [];
        let strListItem = '';
        const line_items = orderData.line_items;
        line_items.map((item, i) => {
            const total = FunctionCommon_1.F_FormatCurrency(item.cr164_quantity * item.cr164_price).replace('￥', '');
            if (sendgridEmailType === Constants_1.SENDGRID_EMAIL.PACKAGE) {
        ...
        if (sendgridEmailType === Constants_1.SENDGRID_EMAIL.PACKAGE) {
            // SENDGRID_EMAIL.PACKAGE
            sendgrid.setApiKey(Constants_1.SENDGRID_API_KEY);
            //#region Custom HTML
            ...
            const header = {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + Constants_1.SENDGRID_API_KEY,
            };
            ...
            const reqDynamicTransactionalEmail = {
                ...
                from: {
                    email: Constants_1.SENDGRID_FROM_EMAIL
                },
                personalizations: [
                    {
                        to: [
            ...
            yield axios_1.default.post(url, reqDynamicTransactionalEmail, { headers: header }).then(respone => {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetListVariantsId = (_req) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_GetListVariantsId_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const product_id = _req.body.product_id;
        const list_sku = _req.body.list_sku;
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Product + '/' + product_id + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.get(url, { headers: header }).then(respone => {
            const product = respone.data.product;
            let data = product.variants.map((variant) => {
                if (!FunctionCommon_1.F_IsNullOrEmptyListItem(list_sku.find((x) => x === variant.sku))) {
                    return {
                        id: variant.id,
                        sku: variant.sku
                    };
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetListVariantsId_02 = (_req) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_GetListVariantsId_02_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const list_sku = _req.body.list_sku;
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Product + '.json?fields=variants';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetListProductsId = (_req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield axios_1.default.get(url, { headers: header }).then(respone => {
            ...
            products.map((product) => {
                product.variants.map((variant) => {
                    if (!FunctionCommon_1.F_IsNullOrEmptyListItem(list_sku.find((x) => x === variant.sku))) {
                        const objProduct = result.find((z) => z === variant.product_id);
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.DeleteCustomerById = (customerId) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const functionName = '_DeactiveCustomerById_';
        const url = Constants_1.CONST_Harada_Endpoints + '2020-04' + '/' + Constants_1.CONST_Harada_Tables.Customers + '/' + customerId + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.SendEmailOperationUI = (_req) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.SendEmailConfirmChangeEmail = (data, name, verification_email_link) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetEmailById = (customerId) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const COUNTRY_CODE_JAPAN = 'JP';
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Customers + '/' + customerId + '.json?fields=email';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.get(url, { headers: header })
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.SendEmailFlowBCheckouts = (_req, env) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_SendEmailFlowBCheckouts_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    const orderData = _req.body.order;
    const orderNo = orderData.orderNo;
    const orderEmail = orderData.orderEmail;
    const order_history_url = Constants_1.ORDER_HISTORY_PAGE + env;
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.SendEmailFlowBCheckouts02 = (_orderNo, _orderEmail, _fullname, env) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_SendEmailFlowBCheckouts_';
    FunctionCommon_1.F_Log(`${functionName} START`);
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.SendEmailOperationUIApproveAll = (env, orderNo, customerId, email, fullname) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.SendEmailOperationUIRemandAll = (env, orderNo, email, fullname) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.SendEmailOperationUIANonAdmitted = (env, orderNo, customerId, email, fullname) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.SendEmailCustomerApproval = (env, orderNo, email, fullname) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.SendEmailCustomerCancel = (env, orderNo, email, fullname) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.SendEmailOperationUI_02 = (orderNo, email, reason, fullname) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetDraftOrderDetail = (draft_order_id) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_GetDraftOrderDetail_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const COUNTRY_CODE_JAPAN = 'JP';
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.DraftOrders + '/' + draft_order_id + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.InsertDraftOrder = (_reqData) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_InsertDraftOrder(Shopify)_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.DraftOrders + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.post(url, draftOrderJSON, { headers: header }).then(respone => {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.UpdateDraftOrder = (draftOrder) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_UpdateDraftOrder(Shopify)_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.DraftOrders + '/' + draftOrder.id + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.DeleteDraftOrder = (draftOrderId) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const functionName = '_DeleteDraftOrder(Shopify)_';
        const url = Constants_1.CONST_Harada_Endpoints + '2020-10' + '/' + Constants_1.CONST_Harada_Tables.DraftOrders + '/' + draftOrderId + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetListOfTransactionsForOrder = (orderId) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_GetListOfTransactionsForOrder_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Order + '/' + orderId + '/' + Constants_1.CONST_Harada_Tables.Transaction + '.json'; //?fields=kind,gateway,amount,parent_id,status,currency';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.InsertTransaction = (orderId, _reqData) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_InsertTransaction(Shopify)_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Order + '/' + orderId + '/' + Constants_1.CONST_Harada_Tables.Transaction + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
        ...
        yield axios_1.default.post(url, transactionJSON, { headers: header }).then(respone => {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetDataByGraphQLAPI = () => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_GetDataByGraphQLAPI_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const endpoint = Constants_1.CONST_Harada_Endpoints + '2023-01/graphql.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.GetListOfRefundsForOrder = (orderId) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_GetListOfRefundsForOrder_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Order + '/' + orderId + '/' + Constants_1.CONST_Harada_Tables.Refund + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
...
* @memberof ShopifyAdminAPI
*/
ShopifyAdminAPI.GetRefundDetail = (orderId, refundId) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_GetRefundDetail_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Order + '/' + orderId + '/' + Constants_1.CONST_Harada_Tables.Refund + '/' + refundId + '.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.InsertRefund = (orderId, _reqData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield axios_1.default.post(url, refundJSON, { headers: header }).then(respone => {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.CalculatesARefund = (orderId, _reqData) => __awaiter(void 0, void 0, void 0, function* () {
    const functionName = '_CalculatesARefund_';
    FunctionCommon_1.F_Log(`${functionName} START`);
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const url = Constants_1.CONST_Harada_Endpoints + Constants_1.CONST_Harada_API_Version + '/' + Constants_1.CONST_Harada_Tables.Order + '/' + orderId + '/' + Constants_1.CONST_Harada_Tables.Refund + '/calculate.json';
        const username = Constants_1.CONST_Harada_API_Key;
        const password = Constants_1.CONST_Harada_Password;
        const base64 = Buffer.from(username + ":" + password, 'utf-8').toString('base64');
        const header = {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.AutoSendEmailForOrdersReceived = (env, orderNo, email) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.AutoSendEmailDesignConfirmationRequest = (env, emailToList, listOfOrder) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.AutoSendEmailForOrdersPaid = (env, orderNo, email) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.AutoSendEmailOrderConfirmed = (env, emailToList, listOfOrder) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.AutoSendEmailForScheduledFlowTest = (email) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.ChargeByStripe = (_req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        const header = {
            ...
            'Authorization': 'Bearer ' + Constants_1.CONST_STRIPE_API_Key,
        };
        let dataRequest = {
        ...
        yield axios_1.default.post(Constants_1.CONST_STRIPE_Endpoints + '/' + Constants_1.CONST_STRIPE_API_Version + '/' + Constants_1.CONST_STRIPE_Tables.Tokens, params, { headers: header }).then((respone) => __awaiter(void 0, void 0, void 0, function* () {
            const data = respone.data;
            ...
            yield axios_1.default.post(Constants_1.CONST_STRIPE_Endpoints + '/' + Constants_1.CONST_STRIPE_API_Version + '/' + Constants_1.CONST_STRIPE_Tables.Charges, params, { headers: header }).then(respone => {
                const data = respone.data;
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.PaymentByStripe = (_req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield axios_1.default.post(Constants_1.CONST_STRIPE_Endpoints + '/' + Constants_1.CONST_STRIPE_API_Version + '/' + Constants_1.CONST_STRIPE_Tables.PaymentMethods, params, { headers: header }).then((respone) => __awaiter(void 0, void 0, void 0, function* () {
            const data = respone.data;
            ...
            yield axios_1.default.post(Constants_1.CONST_STRIPE_Endpoints + '/' + Constants_1.CONST_STRIPE_API_Version + '/' + Constants_1.CONST_STRIPE_Tables.PaymentIntents, params, { headers: header }).then((respone) => __awaiter(void 0, void 0, void 0, function* () {
                const data = respone.data;
                const paymentIntentId = data.id;
                console.log('_PaymentIntentId_', paymentIntentId);
                // Confirm a PaymentIntent
                yield axios_1.default.post(Constants_1.CONST_STRIPE_Endpoints + '/' + Constants_1.CONST_STRIPE_API_Version + '/' + Constants_1.CONST_STRIPE_Tables.PaymentIntents + '/' + paymentIntentId + '/confirm', null, { headers: header }).then(respone => {
                    const data = respone.data;
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.InvoiceItemByStripe = (_req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let params = querystring.stringify(dataRequest);
        yield axios_1.default.post(Constants_1.CONST_STRIPE_Endpoints + '/' + Constants_1.CONST_STRIPE_API_Version + '/' + Constants_1.CONST_STRIPE_Tables.InvoiceItems, params, { headers: header }).then((respone) => __awaiter(void 0, void 0, void 0, function* () {
            const data = respone.data;
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.InvoiceByStripe = (_req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let params = querystring.stringify(dataRequest);
        yield axios_1.default.post(Constants_1.CONST_STRIPE_Endpoints + '/' + Constants_1.CONST_STRIPE_API_Version + '/' + Constants_1.CONST_STRIPE_Tables.Invoices, params, { headers: header }).then((respone) => __awaiter(void 0, void 0, void 0, function* () {
            const data = respone.data;
 ...
 * @memberof ShopifyAdminAPI
 */
ShopifyAdminAPI.PaymentIntentsStripe = (_subTotal) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield axios_1.default.post(Constants_1.CONST_STRIPE_Endpoints + '/' + Constants_1.CONST_STRIPE_API_Version + '/' + Constants_1.CONST_STRIPE_Tables.PaymentIntents, params, { headers: header }).then(respone => {
            const data = respone.data;
...
//# sourceMappingURL=ShopifyAdminAPI.js.map