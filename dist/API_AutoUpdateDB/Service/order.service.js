...
const Entity_order_management_1 = require("../../API_Harada/CDSEntities/Entity_order_management");
const Model_order_management_1 = require("../../API_Harada/CDSModel/Model_order_management");
...
OrderService.addOrder = (data) => {
    FunctionCommon_1.F_Log(`START add Order event -> update by checkout token`);
    const checkout_token = data.checkout_token.toString();
    return new Promise((resolve) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            // Get order to check exist
            const arrOrder = yield Model_order_management_1.Model_order_management.SelectByFieldName(Entity_order_management_1.CONST_column_order_management.cr164_checkout_token, `'${checkout_token}'`);
            // Case exist
            if (arrOrder.length) {
                for (let i = 0; i < arrOrder.length; i++) {
                    const order = arrOrder[i];
                    const entity_order_management = {
                        cr164_order_managementid: '',
                        cr164_order_number: data.id.toString(),
                    ...
                    const result = yield Model_order_management_1.Model_order_management.UpdateByAutoID(order.cr164_order_managementid, entity_order_management);
                    resolve(result);
                }
            }
            else {
...
OrderService.updateOrder = (data) => {
    FunctionCommon_1.F_Log(`START update Order by checkout token`);
    const checkout_token = data.checkout_token.toString();
    return new Promise((resolve) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            // Get order to check exist
 ...
 * @returns
 */
OrderService.deleteOrder = (data) => {
    FunctionCommon_1.F_Log(`START delete Order`);
    return new Promise((resolve) => __awaiter(void 0, void 0, void 0, function* () {
        resolve(null);
    }));
    //#region Don't use
 ...
 * @returns
 */
OrderService.cancelledOrder = (data) => {
    FunctionCommon_1.F_Log(`START cancelledOrder`);
    return new Promise((resolve) => __awaiter(void 0, void 0, void 0, function* () {
        resolve(null);
    }));
};
 ...
 * @returns
 */
OrderService.fulfilledOrder = (data) => {
    FunctionCommon_1.F_Log(`START fulfilledOrder`);
    return new Promise((resolve) => __awaiter(void 0, void 0, void 0, function* () {
        resolve(null);
    }));
};
 ...
 * @returns
 */
OrderService.paidOrder = (data) => {
    FunctionCommon_1.F_Log(`START paidOrder`);
    return new Promise((resolve) => __awaiter(void 0, void 0, void 0, function* () {
        resolve(null);
    }));
};
 ...
 * @returns
 */
OrderService.partially_fulfilledOrder = (data) => {
    FunctionCommon_1.F_Log(`START partially_fulfilledOrder`);
    return new Promise((resolve) => __awaiter(void 0, void 0, void 0, function* () {
        resolve(null);
    }));
};
